...
//	this setVariable ["Var_GF_SCL_Unsung_playerSide", true];
	
		
diag_log "//________________	GF Set Custom Loadout Script Initializing	_____________";
diag_log "//________________	GF_SCL_Unsung_playerSide.sqf	_____________";

systemchat "GF Set Custom Loadout Script Initializing";


//________________ GF_SCL_Unsung_playerSide.sqf _____________


GF_SCL_Unsung_playerSide_primaryWeapon_array = [
...
GF_SCL_Unsung_playerSide_secondaryWeapon_array = [
// Launchers
"uns_B40",
"uns_m72",
"uns_m127a1_flare",
...
GF_SCL_Unsung_playerSide_handgunWeapon_array = [
...
GF_SCL_Unsung_playerSide_Civilian_Uniform_Custom_array = [
...
GF_SCL_Unsung_playerSide_Uniform_array = [
//	Unsung Uniforms
"UNS_ARMY_BDU",
"UNS_ARMY_BDU_F",
"UNS_ARMY_BDU_65",
...
GF_SCL_Unsung_playerSide_Vests_array =  [
//	Unsung Vests
"UNS_JP_Vest",
"UNS_FLAK",
"UNS_M1956_P1",
...
GF_SCL_Unsung_playerSide_Backpacks_array = [
//	Unsung Backpacks
"UNS_Alice_F1",
"UNS_Alice_F2",
"UNS_Alice_F3",
...
GF_SCL_Unsung_playerSide_Headgear_array = [
//	UnsungHeadgear
"UNS_Beret_MRF",
"UNS_Beret_B",
"UNS_Beret_5",
...
GF_SCL_Unsung_playerSide_Goggles_array = [
//	Glasses Vanilla
"G_Spectacles",
"G_Spectacles_Tinted",			
"G_Squares",
...
GF_SCL_Unsung_playerSide_items_array_1 = [
//	Vanilla			
"ToolKit",
"MediKit",
"FirstAidKit",
...
GF_SCL_Unsung_playerSide_items_array_2 = [
...
GF_SCL_Unsung_playerSide_items_array_3 = [
//	Flares
"Chemlight_blue",
"Chemlight_green",
"Chemlight_red",
...
GF_SCL_Unsung_playerSide_Ravage_items_array = [		
//	Ravage_items
//	x1
...
GF_SCL_Unsung_playerSide_ACE3_mod_Medical_array = [
"ACE_atropine",
"ACE_fieldDressing",
"ACE_elasticBandage",
"ACE_quikclot",
...
GF_SCL_Unsung_playerSide_ACE3_mod_items_array = [
//	AtragMX
"ACE_ATragMX",
...
GF_SCL_Unsung_playerSide_Exclude_List = [
...
GF_SCL_Unsung_playerSide_Exclude_List_Gear = [
...
_this addEventHandler ["Respawn", {
	...
	_unit setVariable ["Var_GF_SCL_Unsung_playerSide",false];
}];
};
...
_Uniform = selectRandom GF_SCL_Unsung_playerSide_Uniform_array;	//	For Civilian : GF_SCL_Unsung_playerSide_Civilian_Uniform_Custom_array
_Headgear = selectRandom GF_SCL_Unsung_playerSide_Headgear_array; 
_Goggles = selectRandom GF_SCL_Unsung_playerSide_Goggles_array; 
_Vests = selectRandom GF_SCL_Unsung_playerSide_Vests_array; 
_Backpacks = selectRandom GF_SCL_Unsung_playerSide_Backpacks_array;
_primaryWeapon = selectRandom GF_SCL_Unsung_playerSide_primaryWeapon_array;
_secondaryWeapon = selectRandom GF_SCL_Unsung_playerSide_secondaryWeapon_array;
_handgunWeapon = selectRandom GF_SCL_Unsung_playerSide_handgunWeapon_array;


//________________ addItemToVest	________________

_items_array_1_addtoVest = selectRandom GF_SCL_Unsung_playerSide_items_array_1;
_items_array_2_addtoVest = selectRandom GF_SCL_Unsung_playerSide_items_array_2;
_items_array_3_addtoVest = selectRandom GF_SCL_Unsung_playerSide_items_array_3;
_Ravage_items_array_addtoVest = selectRandom GF_SCL_Unsung_playerSide_Ravage_items_array;
_ACE3_mod_Medical_array_addtoVest = selectRandom GF_SCL_Unsung_playerSide_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoVest = selectRandom GF_SCL_Unsung_playerSide_ACE3_mod_items_array;

//________________ addItemToBackpack	________________

_items_array_1_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_items_array_1;
_items_array_2_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_items_array_2;
_items_array_3_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_items_array_3;
_Ravage_items_array_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_Ravage_items_array;
_ACE3_mod_Medical_array_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoBackpack = selectRandom GF_SCL_Unsung_playerSide_ACE3_mod_items_array;
...
if (_removeallweapons) then {
	...
	if (!((typeOf _this) in GF_SCL_Unsung_playerSide_Exclude_List_Gear)) then {
	removeallweapons _this;
	};
...
GF_SCL_Unsung_playerSide_Change_Equipment_civilian = {
...
_Uniform = selectRandom GF_SCL_Unsung_playerSide_Civilian_Uniform_Custom_array;	//	GF_SCL_Unsung_playerSide_Uniform_array;
_Headgear = selectRandom GF_SCL_Unsung_playerSide_Headgear_array; 
_Goggles = selectRandom GF_SCL_Unsung_playerSide_Goggles_array; 
_Vests = selectRandom GF_SCL_Unsung_playerSide_Vests_array; 
_Backpacks = selectRandom GF_SCL_Unsung_playerSide_Backpacks_array;
...
3.	you can also spawn this for a certain unit :
	name this unit  ex : GF_SCL_Unsung_playerSide_1
	GF_SCL_Unsung_playerSide_1 spawn GF_SCL_Unsung_playerSide;
 
4. 	you can also spawn this for a certain unit in the Editor :
	add this in the init of a unit :
	null = this execVM "GF_SCL_Unsung_playerSide\GF_SCL_Unsung_playerSide.sqf";

	and add instead of the spawn code in the end :
	_this spawn GF_SCL_Unsung_playerSide;
	
5.	only for player : 
	player spawn GF_SCL_Unsung_playerSide;
	
6.	for everyone : 
	null = {_x spawn GF_SCL_Unsung_playerSide_Spawn_Custom_Equipment;}forEach allUnits;
*/
//________________	End	________________	 
...
[] spawn {
	while {true} do {		
		...
		if (
		((alive _x)) 
		&& (!(_x getVariable ["Var_GF_SCL_Unsung_playerSide",false])) 
		&& (!((typeOf _x) in GF_SCL_Unsung_playerSide_Exclude_List)) 
		...
		*/
		...
		&& (side group _x == playerSide)
			...
			_x spawn GF_SCL_Unsung_playerSide;
			
			};						
			_x setVariable ["Var_GF_SCL_Unsung_playerSide",true];
			{waitUntil {!alive _x};
			_x setVariable ["Var_GF_SCL_Unsung_playerSide",false];		 
			};
		}forEach allUnits;
		sleep 5;
	};
