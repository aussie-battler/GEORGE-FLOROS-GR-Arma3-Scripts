...
//	this setVariable ["Var_GF_SCL_playerSide", true];
	
	
diag_log "//________________	GF Set Custom Loadout Script Initializing	_____________";
diag_log "//________________	GF_SCL_playerSide.sqf	_____________";

systemchat "GF Set Custom Loadout Script Initializing";


//________________ GF_SCL_playerSide.sqf _____________


GF_SCL_playerSide_primaryWeapon_array = [
//	LightMachineGuns
...
GF_SCL_playerSide_secondaryWeapon_array = [
	// Launchers
...
GF_SCL_playerSide_handgunWeapon_array = [
//	Pistols
"hgun_ACPC2_F",
"hgun_P07_F",
...
GF_SCL_playerSide_Civilian_Uniform_Custom_array = [
...
GF_SCL_playerSide_Uniform_array = [
"U_C_Journalist",
"U_C_Poloshirt_blue",
...
GF_SCL_playerSide_Backpacks_array = [
"B_AssaultPack_blk",
"B_AssaultPack_cbr",
"B_AssaultPack_dgtl",
"B_AssaultPack_khk",
...
GF_SCL_playerSide_Headgear_array = [
"H_Cap_blk",
"H_Cap_blk_Raven",
"H_Cap_blu",
"H_Cap_brn_SPECOPS",
...
GF_SCL_playerSide_Goggles_array = [
"G_Spectacles",
"G_Spectacles_Tinted",
"G_Combat",
"G_Lowprofile",
...
GF_SCL_playerSide_items_array_1 = [
//for RyanZombies
...
GF_SCL_playerSide_items_array_2 = [
...
GF_SCL_playerSide_items_array_3 = [
//	Flares
"Chemlight_blue",
"Chemlight_green",
"Chemlight_red",
...
GF_SCL_playerSide_Ravage_items_array = [		
//	Ravage_items
//	x1
...
GF_SCL_playerSide_ACE3_mod_Medical_array = [
"ACE_atropine",
"ACE_fieldDressing",
"ACE_elasticBandage",
"ACE_quikclot",
...
GF_SCL_playerSide_ACE3_mod_items_array = [
//	AtragMX
"ACE_ATragMX",
...
GF_SCL_playerSide_Exclude_List = [
...
GF_SCL_playerSide_Exclude_List_Gear = [
...
_this addEventHandler ["Respawn", {
	...
	_unit setVariable ["Var_GF_SCL_playerSide",false];
}];
};
...
_Uniform = selectRandom GF_SCL_playerSide_Uniform_array;	//	For Civilian : GF_SCL_playerSide_Civilian_Uniform_Custom_array
_Headgear = selectRandom GF_SCL_playerSide_Headgear_array; 
_Goggles = selectRandom GF_SCL_playerSide_Goggles_array; 
_Vests = selectRandom GF_SCL_playerSide_Vests_array; 
_Backpacks = selectRandom GF_SCL_playerSide_Backpacks_array;
_primaryWeapon = selectRandom GF_SCL_playerSide_primaryWeapon_array;
_secondaryWeapon = selectRandom GF_SCL_playerSide_secondaryWeapon_array;
_handgunWeapon = selectRandom GF_SCL_playerSide_handgunWeapon_array;


//________________ addItemToVest	________________

_items_array_1_addtoVest = selectRandom GF_SCL_playerSide_items_array_1;
_items_array_2_addtoVest = selectRandom GF_SCL_playerSide_items_array_2;
_items_array_3_addtoVest = selectRandom GF_SCL_playerSide_items_array_3;
_Ravage_items_array_addtoVest = selectRandom GF_SCL_playerSide_Ravage_items_array;
_ACE3_mod_Medical_array_addtoVest = selectRandom GF_SCL_playerSide_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoVest = selectRandom GF_SCL_playerSide_ACE3_mod_items_array;

//________________ addItemToBackpack	________________

_items_array_1_addtoBackpack = selectRandom GF_SCL_playerSide_items_array_1;
_items_array_2_addtoBackpack = selectRandom GF_SCL_playerSide_items_array_2;
_items_array_3_addtoBackpack = selectRandom GF_SCL_playerSide_items_array_3;
_Ravage_items_array_addtoBackpack = selectRandom GF_SCL_playerSide_Ravage_items_array;
_ACE3_mod_Medical_array_addtoBackpack = selectRandom GF_SCL_playerSide_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoBackpack = selectRandom GF_SCL_playerSide_ACE3_mod_items_array;
...
if (_removeallweapons) then {
	...
	if (!((typeOf _this) in GF_SCL_playerSide_Exclude_List_Gear)) then {
	removeallweapons _this;
	};
...
GF_SCL_playerSide_Change_Equipment_civilian = {
...
_Uniform = selectRandom GF_SCL_playerSide_Civilian_Uniform_Custom_array;	//	GF_SCL_playerSide_Uniform_array;
_Headgear = selectRandom GF_SCL_playerSide_Headgear_array; 
_Goggles = selectRandom GF_SCL_playerSide_Goggles_array; 
_Vests = selectRandom GF_SCL_playerSide_Vests_array; 
_Backpacks = selectRandom GF_SCL_playerSide_Backpacks_array;
...
3.	you can also spawn this for a certain unit :
	name this unit  ex : GF_SCL_playerSide_1
	GF_SCL_playerSide_1 spawn GF_SCL_playerSide;
 
4. 	you can also spawn this for a certain unit in the Editor :
	add this in the init of a unit :
	null = this execVM "GF_SCL_playerSide\GF_SCL_playerSide.sqf";

	and add instead of the spawn code in the end :
	_this spawn GF_SCL_playerSide;
	
5.	only for player : 
	player spawn GF_SCL_playerSide;
	
6.	for everyone : 
	null = {_x spawn GF_SCL_playerSide_Spawn_Custom_Equipment;}forEach allUnits;
*/
//________________	End	________________	 
...
[] spawn {
	while {true} do {		
		...
		if (
		((alive _x)) 
		&& (!(_x getVariable ["Var_GF_SCL_playerSide",false])) 
		&& (!((typeOf _x) in GF_SCL_playerSide_Exclude_List)) 
		...
		*/
		...
		&& (side group _x == playerSide)
			...
			_x spawn GF_SCL_playerSide;
			
			};						
			_x setVariable ["Var_GF_SCL_playerSide",true];
			{waitUntil {!alive _x};
			_x setVariable ["Var_GF_SCL_playerSide",false];		 
			};
		}forEach allUnits;
		sleep 5;
	};
