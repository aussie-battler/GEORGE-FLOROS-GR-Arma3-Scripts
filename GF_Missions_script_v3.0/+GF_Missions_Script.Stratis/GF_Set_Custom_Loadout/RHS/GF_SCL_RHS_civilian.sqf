...
//	this setVariable ["Var_GF_SCL_RHS_civilian", true];
	
	
diag_log "//________________	GF Set Custom Loadout Script Initializing	_____________";
diag_log "//________________	GF_SCL_RHS_civilian.sqf	_____________";

systemchat "GF Set Custom Loadout Script Initializing";


//________________ GF_SCL_RHS_civilian.sqf _____________


GF_SCL_RHS_civilian_primaryWeapon_array = [
...
GF_SCL_RHS_civilian_secondaryWeapon_array = [
// Launchers
"rhs_weap_m72a7",
"rhs_weap_M136",
"rhs_weap_M136_hedp",
...
GF_SCL_RHS_civilian_handgunWeapon_array = [
...
GF_SCL_RHS_civilian_Civilian_Uniform_Custom_array = [
...
GF_SCL_RHS_civilian_Uniform_array = [
...
GF_SCL_RHS_civilian_Vests_array =  [
...
GF_SCL_RHS_civilian_Backpacks_array = [
...
GF_SCL_RHS_civilian_Headgear_array = [
...
GF_SCL_RHS_civilian_Goggles_array = [
//	Optic gear
"rhs_googles_black",
"rhs_googles_clear",
"rhs_googles_yellow",
...
GF_SCL_RHS_civilian_items_array_1 = [
//for RyanZombies
...
GF_SCL_RHS_civilian_items_array_2 = [
...
GF_SCL_RHS_civilian_items_array_3 = [
//	Flares
"Chemlight_blue",
"Chemlight_green",
"Chemlight_red",
...
GF_SCL_RHS_civilian_Ravage_items_array = [		
//	Ravage_items
//	x1
...
GF_SCL_RHS_civilian_ACE3_mod_Medical_array = [
"ACE_atropine",
"ACE_fieldDressing",
"ACE_elasticBandage",
"ACE_quikclot",
...
GF_SCL_RHS_civilian_ACE3_mod_items_array = [
//	AtragMX
"ACE_ATragMX",
...
GF_SCL_RHS_civilian_Exclude_List = [
...
GF_SCL_RHS_civilian_Exclude_List_Gear = [
...
_this addEventHandler ["Respawn", {
	...
	_unit setVariable ["Var_GF_SCL_RHS_civilian",false];
}];
};
...
_Uniform = selectRandom GF_SCL_RHS_civilian_Uniform_array;	//	For Civilian : GF_SCL_RHS_civilian_Civilian_Uniform_Custom_array
_Headgear = selectRandom GF_SCL_RHS_civilian_Headgear_array; 
_Goggles = selectRandom GF_SCL_RHS_civilian_Goggles_array; 
_Vests = selectRandom GF_SCL_RHS_civilian_Vests_array; 
_Backpacks = selectRandom GF_SCL_RHS_civilian_Backpacks_array;
_primaryWeapon = selectRandom GF_SCL_RHS_civilian_primaryWeapon_array;
_secondaryWeapon = selectRandom GF_SCL_RHS_civilian_secondaryWeapon_array;
_handgunWeapon = selectRandom GF_SCL_RHS_civilian_handgunWeapon_array;


//________________ addItemToVest	________________

_items_array_1_addtoVest = selectRandom GF_SCL_RHS_civilian_items_array_1;
_items_array_2_addtoVest = selectRandom GF_SCL_RHS_civilian_items_array_2;
_items_array_3_addtoVest = selectRandom GF_SCL_RHS_civilian_items_array_3;
_Ravage_items_array_addtoVest = selectRandom GF_SCL_RHS_civilian_Ravage_items_array;
_ACE3_mod_Medical_array_addtoVest = selectRandom GF_SCL_RHS_civilian_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoVest = selectRandom GF_SCL_RHS_civilian_ACE3_mod_items_array;

//________________ addItemToBackpack	________________

_items_array_1_addtoBackpack = selectRandom GF_SCL_RHS_civilian_items_array_1;
_items_array_2_addtoBackpack = selectRandom GF_SCL_RHS_civilian_items_array_2;
_items_array_3_addtoBackpack = selectRandom GF_SCL_RHS_civilian_items_array_3;
_Ravage_items_array_addtoBackpack = selectRandom GF_SCL_RHS_civilian_Ravage_items_array;
_ACE3_mod_Medical_array_addtoBackpack = selectRandom GF_SCL_RHS_civilian_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoBackpack = selectRandom GF_SCL_RHS_civilian_ACE3_mod_items_array;
...
if (_removeallweapons) then {
	...
	if (!((typeOf _this) in GF_SCL_RHS_civilian_Exclude_List_Gear)) then {
	removeallweapons _this;
	};
...
GF_SCL_RHS_civilian_Change_Equipment_civilian = {
...
_Uniform = selectRandom GF_SCL_RHS_civilian_Civilian_Uniform_Custom_array;	//	GF_SCL_RHS_civilian_Uniform_array;
_Headgear = selectRandom GF_SCL_RHS_civilian_Headgear_array; 
_Goggles = selectRandom GF_SCL_RHS_civilian_Goggles_array; 
_Vests = selectRandom GF_SCL_RHS_civilian_Vests_array; 
_Backpacks = selectRandom GF_SCL_RHS_civilian_Backpacks_array;
...
3.	you can also spawn this for a certain unit :
	name this unit  ex : GF_SCL_RHS_civilian_1
	GF_SCL_RHS_civilian_1 spawn GF_SCL_RHS_civilian;
 
4. 	you can also spawn this for a certain unit in the Editor :
	add this in the init of a unit :
	null = this execVM "GF_SCL_RHS_civilian\GF_SCL_RHS_civilian.sqf";

	and add instead of the spawn code in the end :
	_this spawn GF_SCL_RHS_civilian;
	
5.	only for player : 
	player spawn GF_SCL_RHS_civilian;
	
6.	for everyone : 
	null = {_x spawn GF_SCL_RHS_civilian_Spawn_Custom_Equipment;}forEach allUnits;
*/
//________________	End	________________	 
...
[] spawn {
	while {true} do {		
		...
		if (
		((alive _x)) 
		&& (!(_x getVariable ["Var_GF_SCL_RHS_civilian",false])) 
		&& (!((typeOf _x) in GF_SCL_RHS_civilian_Exclude_List)) 
		...
		*/
		...
		&& (side group _x == civilian)
			...
			_x spawn GF_SCL_RHS_civilian;
			
			};						
			_x setVariable ["Var_GF_SCL_RHS_civilian",true];
			{waitUntil {!alive _x};
			_x setVariable ["Var_GF_SCL_RHS_civilian",false];		 
			};
		}forEach allUnits;
		sleep 5;
	};
