...
//	this setVariable ["Var_GF_SCL_CUP_west", true];
	
	
diag_log "//________________	GF Set Custom Loadout Script Initializing	_____________";
diag_log "//________________	GF_SCL_CUP_west.sqf	_____________";

systemchat "GF Set Custom Loadout Script Initializing";


//________________ GF_SCL_CUP_west.sqf _____________


GF_SCL_CUP_west_primaryWeapon_array = [
//	LightMachineGuns
"CUP_lmg_UK59",
"CUP_arifle_RPK74",
"CUP_arifle_RPK74_45",
...
GF_SCL_CUP_west_secondaryWeapon_array = [
// Launchers
...
GF_SCL_CUP_west_handgunWeapon_array = [
//	Pistols
"CUP_hgun_Duty",
"CUP_hgun_Duty_M3X",
"CUP_hgun_Phantom",
...
GF_SCL_CUP_west_Civilian_Uniform_Custom_array = [
"CUP_U_O_Villager_03",
"CUP_U_O_Villager_04",
"CUP_U_I_Villager_03",
"CUP_U_I_Villager_04",
...
GF_SCL_CUP_west_Backpacks_array = [
//	Backpacks
"CUP_B_AGS30_Gun_Bag",
...
GF_SCL_CUP_west_Headgear_array = [
//	RacingHelmet
"H_RacingHelmet_2_F", 
"H_RacingHelmet_3_F", 
"H_RacingHelmet_4_F",  
...
GF_SCL_CUP_west_Ravage_items_array = [		
//	Ravage_items
//	x1
...
GF_SCL_CUP_west_ACE3_mod_Medical_array = [
"ACE_atropine",
"ACE_fieldDressing",
"ACE_elasticBandage",
"ACE_quikclot",
...
GF_SCL_CUP_west_ACE3_mod_items_array = [
//	AtragMX
"ACE_ATragMX",
...
GF_SCL_CUP_west_Exclude_List_Gear = [
...
_this addEventHandler ["Respawn", {
	...
	_unit setVariable ["Var_GF_SCL_CUP_west",false];
}];
};
...
_Uniform = selectRandom GF_SCL_CUP_west_Uniform_array;	//	For Civilian : GF_SCL_CUP_west_Civilian_Uniform_Custom_array
_Headgear = selectRandom GF_SCL_CUP_west_Headgear_array; 
_Goggles = selectRandom GF_SCL_CUP_west_Goggles_array; 
_Vests = selectRandom GF_SCL_CUP_west_Vests_array; 
_Backpacks = selectRandom GF_SCL_CUP_west_Backpacks_array;
_primaryWeapon = selectRandom GF_SCL_CUP_west_primaryWeapon_array;
_secondaryWeapon = selectRandom GF_SCL_CUP_west_secondaryWeapon_array;
_handgunWeapon = selectRandom GF_SCL_CUP_west_handgunWeapon_array;


//________________ addItemToVest	________________

_items_array_1_addtoVest = selectRandom GF_SCL_CUP_west_items_array_1;
_items_array_2_addtoVest = selectRandom GF_SCL_CUP_west_items_array_2;
_items_array_3_addtoVest = selectRandom GF_SCL_CUP_west_items_array_3;
_Ravage_items_array_addtoVest = selectRandom GF_SCL_CUP_west_Ravage_items_array;
_ACE3_mod_Medical_array_addtoVest = selectRandom GF_SCL_CUP_west_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoVest = selectRandom GF_SCL_CUP_west_ACE3_mod_items_array;

//________________ addItemToBackpack	________________

_items_array_1_addtoBackpack = selectRandom GF_SCL_CUP_west_items_array_1;
_items_array_2_addtoBackpack = selectRandom GF_SCL_CUP_west_items_array_2;
_items_array_3_addtoBackpack = selectRandom GF_SCL_CUP_west_items_array_3;
_Ravage_items_array_addtoBackpack = selectRandom GF_SCL_CUP_west_Ravage_items_array;
_ACE3_mod_Medical_array_addtoBackpack = selectRandom GF_SCL_CUP_west_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoBackpack = selectRandom GF_SCL_CUP_west_ACE3_mod_items_array;
...
if (_removeallweapons) then {
	...
	if (!((typeOf _this) in GF_SCL_CUP_west_Exclude_List_Gear)) then {
	removeallweapons _this;
	};
...
GF_SCL_CUP_west_Change_Equipment_civilian = {
...
_Uniform = selectRandom GF_SCL_CUP_west_Civilian_Uniform_Custom_array;	//	GF_SCL_CUP_west_Uniform_array;
_Headgear = selectRandom GF_SCL_CUP_west_Headgear_array; 
_Goggles = selectRandom GF_SCL_CUP_west_Goggles_array; 
_Vests = selectRandom GF_SCL_CUP_west_Vests_array; 
_Backpacks = selectRandom GF_SCL_CUP_west_Backpacks_array;
...
3.	you can also spawn this for a certain unit :
	name this unit  ex : GF_SCL_CUP_west_1
	GF_SCL_CUP_west_1 spawn GF_SCL_CUP_west;
 
4. 	you can also spawn this for a certain unit in the Editor :
	add this in the init of a unit :
	null = this execVM "GF_SCL_CUP_west\GF_SCL_CUP_west.sqf";

	and add instead of the spawn code in the end :
	_this spawn GF_SCL_CUP_west;
	
5.	only for player : 
	player spawn GF_SCL_CUP_west;
	
6.	for everyone : 
	null = {_x spawn GF_SCL_CUP_west_Spawn_Custom_Equipment;}forEach allUnits;
*/
//________________	End	________________	 
...
[] spawn {
	while {true} do {		
		...
		if (
		((alive _x)) 
		&& (!(_x getVariable ["Var_GF_SCL_CUP_west",false])) 
		&& (!((typeOf _x) in GF_SCL_CUP_west_Exclude_List)) 
		...
		*/
		...
		&& (side group _x == west)
			...
			_x spawn GF_SCL_CUP_west;
			
			};						
			_x setVariable ["Var_GF_SCL_CUP_west",true];
			{waitUntil {!alive _x};
			_x setVariable ["Var_GF_SCL_CUP_west",false];		 
			};
		}forEach allUnits;
		sleep 5;
	};
