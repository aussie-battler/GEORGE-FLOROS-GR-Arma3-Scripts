...
[] spawn GF_Missions_Garrison_The_Building_Infantry_Recon_SF;			//	add the name of the building ex : [_Building] spawn GF_Missions_Garrison_The_Building_Infantry;
[] spawn GF_Missions_Garrison_Area_Buildings_Infantry_Recon_SF;
*/


//________________	GF_Missions_Spawn_Infantry_Recon_SF_Patrol	________________

GF_Missions_Spawn_Infantry_Recon_SF_Patrol = {
...
_unit = _Group createunit [GF_Missions_Pool_Infantry_Recon_SF select floor(random count GF_Missions_Pool_Infantry_Recon_SF),_Pos_Spawn,[],0,"None"];
...
//________________	GF_Missions_Spawn_Infantry_Recon_SF_Defend	________________	

GF_Missions_Spawn_Infantry_Recon_SF_Defend = {
...
//________________	GF_Missions_Spawn_Infantry_Recon_SF_Attack	________________

GF_Missions_Spawn_Infantry_Recon_SF_Attack = {
...
//________________	GF_Missions_Garrison_The_Building_Infantry_Recon_SF	________________ 

GF_Missions_Garrison_The_Building_Infantry_Recon_SF = {
...
//________________	GF_Missions_Garrison_Area_Buildings_Infantry_Recon_SF	________________ 

GF_Missions_Garrison_Area_Buildings_Infantry_Recon_SF = {
...
for "_i" from 0 to 50 do {
	...
	_Group = createGroup GF_Missions_Enemy_Side;
	_Unit = _Group createunit [GF_Missions_Pool_Infantry_Recon_SF select floor(random count GF_Missions_Pool_Infantry_Recon_SF),_buildingpos,[],0,"None"];
	[_Unit] JoinSilent _Group;
	_Unit disableAI "PATH";
