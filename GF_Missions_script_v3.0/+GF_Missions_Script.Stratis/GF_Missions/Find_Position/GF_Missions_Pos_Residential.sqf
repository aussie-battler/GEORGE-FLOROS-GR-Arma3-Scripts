...
if (GF_Missions_Systemchat_info) then {
	systemchat "_Residential_Found"; 
	systemchat format ["%1",_Residential_Position]; 
};
...
if (GF_Missions_Systemchat_info) then {
systemchat format ["There is NO Residential , spawning on random : %1",_Residential_Found]; 
};	

if (GF_Missions_Diag_Log_info) then {
diag_log format ["There is NO Residential , spawning on random : %1",_Residential_Found]; 
};
...
if (GF_Missions_Systemchat_info) then {
systemchat format ["Position Residential Found %1",_Found];
};	

if (GF_Missions_Diag_Log_info) then {
diag_log format ["Position Residential Found %1",_Found];
};
