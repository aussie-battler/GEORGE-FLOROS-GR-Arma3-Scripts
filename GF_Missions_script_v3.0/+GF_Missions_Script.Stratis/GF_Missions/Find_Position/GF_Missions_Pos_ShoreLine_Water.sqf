...
hintsilent format ["Attempts for _ShoreLine_Water Position : %1",_a];
};
...
systemchat format ["Position _ShoreLine_Water Found %1",_Found];
};	

if (GF_Missions_Diag_Log_info) then {
diag_log format ["Position _ShoreLine_Water Found %1",_Found];
};
...
if (GF_Missions_Systemchat_info) then {
systemchat "Position _ShoreLine_Water not Found !";
systemchat "Selecting a Random Position";
};	

if (GF_Missions_Diag_Log_info) then {
diag_log "Position _ShoreLine_Water not Found !";
