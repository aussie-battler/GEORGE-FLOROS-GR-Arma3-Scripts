...
systemchat format ["Position isEmpty Found %1",_Found];
};	

if (GF_Missions_Diag_Log_info) then {
diag_log format ["Position isEmpty Found %1",_Found];
};
...
if (GF_Missions_Systemchat_info) then {
systemchat "Position isEmpty not Found !";
systemchat "Selecting a Random Position";
};	

if (GF_Missions_Diag_Log_info) then {
diag_log "Position isEmpty not Found !";
