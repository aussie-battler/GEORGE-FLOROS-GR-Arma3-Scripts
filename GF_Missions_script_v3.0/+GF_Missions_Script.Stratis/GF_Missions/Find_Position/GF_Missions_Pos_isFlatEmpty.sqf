...
hintsilent format ["Attempts for isFlatEmpty Position : %1",_a];
};
...
systemchat format ["Position isFlatEmpty Found %1",_Found];
};	

if (GF_Missions_Diag_Log_info) then {
diag_log format ["Position isFlatEmpty Found %1",_Found];
};
...
if (GF_Missions_Systemchat_info) then {
systemchat "Position isFlatEmpty not Found !";
systemchat "Selecting a Random Position";
};	

if (GF_Missions_Diag_Log_info) then {
diag_log "Position isFlatEmpty not Found !";
