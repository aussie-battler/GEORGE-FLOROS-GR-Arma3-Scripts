...
diag_log "//________________	10_Move_to_Escort.sqf	Initializing	_____________";
diag_log "________________	taskSetState	10_Move_to_Escort_1	________________";
diag_log "________________	taskSetState	10_Move_to_Escort_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "10_Move_to_Escort Initializing";
};
...
[GF_Missions_allPlayers,["10_Move_to_Escort_1","GF_Missions_Pack"],["Move to Location , Follow directions","Move to Location",""], _Offroad,true,1,true,"move",true] call BIS_fnc_taskCreate;
["10_Move_to_Escort_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	10_Move_to_Escort.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "10_Move_to_Escort.sqf	Initialized";
};	
...
["10_Move_to_Escort_1","FAILED",true] spawn BIS_fnc_taskSetState;
["10_Move_to_Escort_2", "FAILED",true] spawn BIS_fnc_taskSetState;
["10_Move_to_Escort_3", "FAILED",true] spawn BIS_fnc_taskSetState;	
["10_Move_to_Escort_4", "FAILED",true] spawn BIS_fnc_taskSetState;				
sleep 5;
...
waitUntil { { _x distance _Offroad < 25 } count GF_Missions_allPlayers > 0 };
...
["10_Move_to_Escort_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
//________________ Spawn the Escort	________________

_Escort = createGroup civilian;
GF_Missions_Escort_10 = _Escort createUnit ["C_journalist_F", _Pos_1, [], 0, "NONE"];
GF_Missions_Escort_10 modelToWorld _Pos_1;
...
GF_Missions_Escort_10 setskill 1;
GF_Missions_Escort_10 disableai "MOVE";

removeAllWeapons GF_Missions_Escort_10;
removeAllItems GF_Missions_Escort_10;
removeAllAssignedItems GF_Missions_Escort_10;
removeUniform GF_Missions_Escort_10;
removeVest GF_Missions_Escort_10;
removeBackpack GF_Missions_Escort_10;
removeHeadgear GF_Missions_Escort_10;
removeGoggles GF_Missions_Escort_10;

GF_Missions_Escort_10 forceAddUniform "U_C_WorkerCoveralls";
[GF_Missions_Escort_10,[0,"GF_Missions\images\GF_Uniform_Prisoner.paa"]] remoteExec ["setObjectTexture",0,true];

//________________	GF_Missions_addaction_Join_Disband	________________

GF_Missions_Escort_10 spawn GF_Missions_addaction_Join_Disband;


//________________ Check if Escort is alive , then Set Task FAILED	________________	

GF_Missions_Escort_10_Killed_Exit = true;

[] spawn {
	while {GF_Missions_Escort_10_Killed_Exit} do {

	if (GF_Missions_saveGame) then {
	systemchat "Check if Escort is alive";
	};	
	
	if (!alive GF_Missions_Escort_10) exitWith{
...
[GF_Missions_allPlayers,["10_Move_to_Escort_2","GF_Missions_Pack"],["Meet the VIP","Meet the VIP",""], _Pos_1,true,1,true,"meet",true] call BIS_fnc_taskCreate;
["10_Move_to_Escort_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
waitUntil { { _x distance GF_Missions_Escort_10 < 4 } count GF_Missions_allPlayers > 0 };
GF_Missions_Escort_10 enableai "MOVE";
...
["10_Move_to_Escort_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
_Object_1 = createVehicle [_Object_1_array, _Pos_1, [], 0, "NONE"];
...
[GF_Missions_allPlayers,["10_Move_to_Escort_3","GF_Missions_Pack"],["Escort VIP","Escort VIP",""], _Pos_1,true,1,true,"move",true] call BIS_fnc_taskCreate;
["10_Move_to_Escort_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;



waitUntil { GF_Missions_Escort_10 distance2d _Pos_1 < 8 };


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Task SUCCEEDED	________________
	
["10_Move_to_Escort_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;


//________________ Stop Checking if Escort is alive	________________	

GF_Missions_Escort_10_Killed_Exit = false;
...
[GF_Missions_allPlayers,["10_Move_to_Escort_4","GF_Missions_Pack"],["Defend the Area","Defend the Area",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["10_Move_to_Escort_4","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["10_Move_to_Escort_4", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
