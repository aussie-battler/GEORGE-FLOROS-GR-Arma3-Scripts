...
diag_log "//________________	9_Move_to.sqf	Initializing	_____________";
diag_log "________________	taskSetState	9_Move_to_1	________________";
diag_log "________________	taskSetState	9_Move_to_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "9_Move_to Initializing";
};
...
[GF_Missions_allPlayers,["9_Move_to_1","GF_Missions_Pack"],["Move to Location , Follow directions","Move to Location",""], _Offroad,true,1,true,"move",true] call BIS_fnc_taskCreate;
["9_Move_to_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	9_Move_to.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "9_Move_to.sqf	Initialized";
};	
...
["9_Move_to_1","FAILED",true] spawn BIS_fnc_taskSetState;
["9_Move_to_2", "FAILED",true] spawn BIS_fnc_taskSetState;	
["9_Move_to_3", "FAILED",true] spawn BIS_fnc_taskSetState;					
sleep 5;
...
["9_Move_to_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
_Building = "Land_BagBunker_Small_F" createVehicle _Pos_1;
_Building setDir (random 360);


//________________ Positions / distance , direction	________________

_Object_1_Pos = [_Pos_1, -10, 20] call BIS_fnc_relPos;
_Object_2_Pos = [_Pos_1, 10, 20] call BIS_fnc_relPos;
...
_Object_3_Pos =  [[[_Pos_1, 10 + random 20]],["water"]] call BIS_fnc_randomPos;
_Object_3 = createVehicle [_Object_3_array, _Object_3_Pos, [], 0, "NONE"];
_Object_3 setDir (random 360);

//________________ Create _Object_4 ________________
_Object_4_Pos =  [[[_Pos_1, 10 + random 20]],["water"]] call BIS_fnc_randomPos;
_Object_4 = createVehicle [_Object_3_array, _Object_4_Pos, [], 0, "NONE"];
...
//________________	Garrison	________________

[_Building] spawn GF_Missions_Garrison_The_Building_Infantry_Prisoners_Armed;
[_Object_1] spawn GF_Missions_Garrison_The_Building_Infantry_Prisoners_Armed;

//________________	GF_Missions_Custom_Spawn	________________

[] spawn GF_Missions_Spawn_Infantry_Prisoners_Armed_Defend;
...
_Group_1 = createGroup GF_Missions_Enemy_Side;

for "_x" from 1 to ( GF_Missions_Squad_Members * 2 ) do {
...
[_Unit,[0,"GF_Missions\images\GF_Uniform_Prisoner.paa"]] remoteExec ["setObjectTexture",0,true];
...
//	add possibility 
if (floor (random 10) < 6) then {_Unit addBackpack _Goggles;};
if (floor (random 10) < 5) then {_Unit addVest _Headgear;};
...
[GF_Missions_allPlayers,["9_Move_to_2","GF_Missions_Pack"],["Prisoners have Escaped , Find the Prisoners","Find Prisoners location",""], _Pos_1,true,1,true,"navigate",true] call BIS_fnc_taskCreate;
["9_Move_to_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["9_Move_to_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["9_Move_to_3","GF_Missions_Pack"],["Eliminate all threats","Eliminate all threats",""], _Pos_1,true,1,true,"kill",true] call BIS_fnc_taskCreate;
["9_Move_to_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;



waitUntil {({alive _x} count units _Group_1) isEqualTo 0;};


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Task SUCCEEDED	________________
	
["9_Move_to_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
