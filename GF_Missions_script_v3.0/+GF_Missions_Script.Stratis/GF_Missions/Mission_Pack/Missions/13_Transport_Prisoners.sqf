...
diag_log "//________________	13_Transport_Prisoners.sqf	Initializing	_____________";
diag_log "________________	taskSetState	13_Transport_Prisoners_1	________________";
diag_log "________________	taskSetState	13_Transport_Prisoners_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "13_Transport_Prisoners Initializing";
};
...
//________________	Police Group	________________

_Pos_2 =  [[[_Pos_1, 5 + random 10]],["water"]] call BIS_fnc_randomPos;
_Group_Police = [ _Pos_2, playerside, [
"B_officer_F","B_officer_F","B_officer_F"
...
//	add possibility 
if (floor (random 10) < 6) then {_x addGoggles _Goggles;};
if (floor (random 10) < 5) then {_x addHeadgear _Headgear;};
if (floor (random 10) < 4) then {_x addVest _Vests;};
...
for "_i" from 1 to 3 do {_x addItemToUniform _Spawn_Primary_Weapon_magazines;};
for "_i" from 1 to 1 do {_x addItemToUniform "FirstAidKit";};
for "_i" from 1 to 1 do {_x addItemToUniform "HandGrenade";};

for "_i" from 1 to 1 do {_x addItemToVest "FirstAidKit";};
...
_x spawn GF_Missions_addaction_Join_Disband_Officer;

}forEach units _Group_Police;


//________________ Spawn the Prisoner 1	________________

_Spawn_GF_Missions_Prisoner_1 = createGroup civilian;
GF_Missions_Prisoner_13_1 = _Spawn_GF_Missions_Prisoner_1 createUnit ["C_man_p_fugitive_F", _Pos_2, [], 0, "NONE"];

//________________ Spawn the Prisoner 2	________________

_Spawn_GF_Missions_Prisoner_2 = createGroup civilian;
GF_Missions_Prisoner_13_2 = _Spawn_GF_Missions_Prisoner_2 createUnit ["C_man_p_fugitive_F", _Pos_2, [], 0, "NONE"];


//________________	Prisoners	________________
{
...
[_x,[0,"GF_Missions\images\GF_Uniform_Prisoner.paa"]] remoteExec ["setObjectTexture",0,true];
_x setcaptive true;
[[_x,"Acts_ExecutionVictim_Loop"] remoteExec ["switchMove"]];
_x disableAI "anim";


//________________	GF_Missions_addaction_Join_Disband_Prisoner	________________

_x spawn GF_Missions_addaction_Join_Disband_Prisoner;

//________________	GF_Missions_addaction_Release_Tie_Prisoner	________________

_x spawn GF_Missions_addaction_Release_Tie_Prisoner;


}forEach [GF_Missions_Prisoner_13_1,GF_Missions_Prisoner_13_2];


//________________ Check if Prisoners are alive , then Set Task FAILED	________________	

GF_Missions_Prisoner_13_Killed_Exit = true;

[] spawn {
	while {GF_Missions_Prisoner_13_Killed_Exit} do {

	if (GF_Missions_saveGame) then {
	systemchat "Check if Prisoners are alive";
	};	
	
	if ((!alive GF_Missions_Prisoner_13_1) && (!alive GF_Missions_Prisoner_13_2))  exitWith{

	["13_Transport_Prisoners_1","FAILED",true] spawn BIS_fnc_taskSetState;
	["13_Transport_Prisoners_2", "FAILED",true] spawn BIS_fnc_taskSetState;
	["13_Transport_Prisoners_3", "FAILED",true] spawn BIS_fnc_taskSetState;
...
[GF_Missions_allPlayers,["13_Transport_Prisoners_1","GF_Missions_Pack"],["Meet up with the Police","Meet up with the Police",""], _Offroad,true,1,true,"meet",true] call BIS_fnc_taskCreate;
["13_Transport_Prisoners_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	13_Transport_Prisoners.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "13_Transport_Prisoners.sqf	Initialized";
};	
...
["13_Transport_Prisoners_2","FAILED",true] spawn BIS_fnc_taskSetState;
["13_Transport_Prisoners_3","FAILED",true] spawn BIS_fnc_taskSetState;
["13_Transport_Prisoners_4","FAILED",true] spawn BIS_fnc_taskSetState;
sleep 5;
...
//________________	Check Task	________________
	...
	waitUntil { { _x distance2d _Offroad < 25 } count GF_Missions_allPlayers > 0 };
...
["13_Transport_Prisoners_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
_Move =  [[[_Pos_1, 1200]],["water"]] call BIS_fnc_randomPos;


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Set Task 2	________________

[GF_Missions_allPlayers,["13_Transport_Prisoners_2","GF_Missions_Pack"],["Move to Location , Follow directions","Move to Location",""], _Move,true,1,true,"move",true] call BIS_fnc_taskCreate;
["13_Transport_Prisoners_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
_Object_1 = createVehicle [_Object_1_array, _Move, [], 0, "none"];
_Object_1 setDir (random 360);

_Object_1 allowDamage false;


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Check Task	________________
	
waitUntil { { _x distance2d _Move < 20 } count GF_Missions_allPlayers > 0 };


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Task SUCCEEDED	________________

["13_Transport_Prisoners_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
...
[GF_Missions_allPlayers,["13_Transport_Prisoners_3","GF_Missions_Pack"],["Move to Location , Escort with Safe there is Enemy presence","Escort with ** CAUTION **",""], _Pos_1,true,1,true,"move",true] call BIS_fnc_taskCreate;
["13_Transport_Prisoners_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
waitUntil { { _x distance _Pos_1 < 20 } count GF_Missions_allPlayers > 0 };


///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//________________	Task SUCCEEDED	________________

["13_Transport_Prisoners_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;


	//________________ Stop Checking if Prisoners are alive	________________	

	GF_Missions_Prisoner_13_Killed_Exit = false;
...
[GF_Missions_allPlayers,["13_Transport_Prisoners_4","GF_Missions_Pack"],["Clear the Area","Clear the Area!",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["13_Transport_Prisoners_4","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["13_Transport_Prisoners_4", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
