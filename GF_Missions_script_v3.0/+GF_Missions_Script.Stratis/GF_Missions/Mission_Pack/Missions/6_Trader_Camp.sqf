...
diag_log "//________________	6_Trader_Camp.sqf	Initializing	_____________";
diag_log "________________	taskSetState	6_Trader_Camp_1	________________";
diag_log "________________	taskSetState	6_Trader_Camp_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "6_Trader_Camp Initializing";
};
...
[GF_Missions_allPlayers,["6_Trader_Camp_1","GF_Missions_Pack"],["Eliminate the Trader Camp","Eliminate the Trader Camp",""], _Mission_Pos,true,1,true,"kill",true] call BIS_fnc_taskCreate;
["6_Trader_Camp_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	6_Trader_Camp.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "6_Trader_Camp.sqf	Initialized";
};	
...
["6_Trader_Camp_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["6_Trader_Camp_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
