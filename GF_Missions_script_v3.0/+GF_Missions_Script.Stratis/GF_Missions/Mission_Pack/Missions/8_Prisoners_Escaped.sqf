...
diag_log "//________________	8_Prisoners_Escaped.sqf	Initializing	_____________";
diag_log "________________	taskSetState	8_Prisoners_Escaped_1	________________";
diag_log "________________	taskSetState	8_Prisoners_Escaped_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "8_Prisoners_Escaped Initializing";
};
...
[GF_Missions_allPlayers,["8_Prisoners_Escaped_1","GF_Missions_Pack"],["Prisoners have Escaped , Find the Prisoners",""], _Mission_Pos,true,1,true,"scout",true] call BIS_fnc_taskCreate;
["8_Prisoners_Escaped_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	8_Prisoners_Escaped.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "8_Prisoners_Escaped.sqf	Initialized";
};	
...
["8_Prisoners_Escaped_1","FAILED",true] spawn BIS_fnc_taskSetState;
["8_Prisoners_Escaped_2", "FAILED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
waitUntil { { _x distance _Offroad < 400 } count GF_Missions_allPlayers > 0 };
...
["8_Prisoners_Escaped_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["8_Prisoners_Escaped_2","GF_Missions_Pack"],["The Prisoners are 400 meters away , they are armed , Eliminate all Threats","Eliminate all Threats",""], getpos _Police_Offroad,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["8_Prisoners_Escaped_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["8_Prisoners_Escaped_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
