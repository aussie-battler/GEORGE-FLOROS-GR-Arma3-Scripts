...
diag_log "//________________	16_Big_Search_Device.sqf	Initializing	_____________";
diag_log "________________	taskSetState	16_Big_Search_Device_1	________________";
diag_log "________________	taskSetState	16_Big_Search_Device_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "16_Big_Search_Device Initializing";
};
...
_Target_1 = createVehicle ["Land_Device_assembled_F", getpos _Building, [], 0, "CAN_COLLIDE"];
...
[GF_Missions_allPlayers,["16_Big_Search_Device_1","GF_Missions_Pack"],["Search for the Device","Search for the Device",""], _Pos_1,true,1,true,"search",true] call BIS_fnc_taskCreate;
["16_Big_Search_Device_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	16_Big_Search_Device.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "16_Big_Search_Device.sqf	Initialized";
};	
...
["16_Big_Search_Device_1","FAILED",true] spawn BIS_fnc_taskSetState;
["16_Big_Search_Device_2","FAILED",true] spawn BIS_fnc_taskSetState;
["16_Big_Search_Device_3","FAILED",true] spawn BIS_fnc_taskSetState;
...
["16_Big_Search_Device_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["16_Big_Search_Device_2","GF_Missions_Pack"],["Destroy the Device","Destroy the Device",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["16_Big_Search_Device_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["16_Big_Search_Device_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["16_Big_Search_Device_3","GF_Missions_Pack"],["*** CAUTION Reinforcements ***","*** CAUTION Reinforcements ***",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["16_Big_Search_Device_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["16_Big_Search_Device_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
