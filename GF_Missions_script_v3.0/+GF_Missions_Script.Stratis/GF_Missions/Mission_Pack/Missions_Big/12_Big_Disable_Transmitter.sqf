...
diag_log "//________________	12_Big_Disable_Transmitter.sqf	Initializing	_____________";
diag_log "________________	taskSetState	12_Big_Disable_Transmitter_1	________________";
diag_log "________________	taskSetState	12_Big_Disable_Transmitter_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "12_Big_Disable_Transmitter Initializing";
};
...
[GF_Missions_allPlayers,["12_Big_Disable_Transmitter_1","GF_Missions_Pack"],["Disable the Transmitter","Disable the Transmitter",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["12_Big_Disable_Transmitter_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	12_Big_Disable_Transmitter.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "12_Big_Disable_Transmitter.sqf	Initialized";
};	
...
["12_Big_Disable_Transmitter_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["12_Big_Disable_Transmitter_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
