...
diag_log "//________________	9_Big_Destroy_Weaponry.sqf	Initializing	_____________";
diag_log "________________	taskSetState	9_Big_Destroy_Weaponry_1	________________";
diag_log "________________	taskSetState	9_Big_Destroy_Weaponry_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "9_Big_Destroy_Weaponry Initializing";
};
...
[GF_Missions_allPlayers,["9_Big_Destroy_Weaponry_1","GF_Missions_Pack"],["Destroy Secret Weaponry","Destroy Secret Weaponry",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["9_Big_Destroy_Weaponry_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	9_Big_Destroy_Weaponry.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "9_Big_Destroy_Weaponry.sqf	Initialized";
};	
...
["9_Big_Destroy_Weaponry_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["9_Big_Destroy_Weaponry_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
