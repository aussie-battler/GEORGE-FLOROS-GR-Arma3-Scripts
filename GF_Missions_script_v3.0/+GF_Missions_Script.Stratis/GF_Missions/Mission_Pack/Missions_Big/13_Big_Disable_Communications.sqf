...
diag_log "//________________	13_Big_Disable_Communications.sqf	Initializing	_____________";
diag_log "________________	taskSetState	13_Big_Disable_Communications_1	________________";
diag_log "________________	taskSetState	13_Big_Disable_Communications_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "13_Big_Disable_Communications Initializing";
};
...
[GF_Missions_allPlayers,["13_Big_Disable_Communications_1","GF_Missions_Pack"],["Disable Communications","Disable Communications",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["13_Big_Disable_Communications_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	13_Big_Disable_Communications.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "13_Big_Disable_Communications.sqf	Initialized";
};	
...
["13_Big_Disable_Communications_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["13_Big_Disable_Communications_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
