...
diag_log "//________________	4_Big_Clear_Village.sqf	Initializing	_____________";
diag_log "________________	taskSetState	4_Big_Clear_Village_1	________________";
diag_log "________________	taskSetState	4_Big_Clear_Village_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "4_Big_Clear_Village Initializing";
};
...
GF_Missions_pos = [] call GF_Missions_Pos_NameVillage;
...
[GF_Missions_allPlayers,["4_Big_Clear_Village_1","GF_Missions_Pack"],["Clear Area","Clear Area",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["4_Big_Clear_Village_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	4_Big_Clear_Village.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "4_Big_Clear_Village.sqf	Initialized";
};	
...
["4_Big_Clear_Village_1","FAILED",true] spawn BIS_fnc_taskSetState;
["4_Big_Clear_Village_2","FAILED",true] spawn BIS_fnc_taskSetState;
...
["4_Big_Clear_Village_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;


//________________	Set Task 2	________________

[GF_Missions_allPlayers,["4_Big_Clear_Village_2","GF_Missions_Pack"],["Defend the Area","Defend the Area",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["4_Big_Clear_Village_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;	
...
["4_Big_Clear_Village_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
