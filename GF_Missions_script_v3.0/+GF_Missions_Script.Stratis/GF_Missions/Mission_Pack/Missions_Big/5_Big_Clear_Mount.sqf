...
diag_log "//________________	5_Big_Clear_Mount.sqf	Initializing	_____________";
diag_log "________________	taskSetState	5_Big_Clear_Mount_1	________________";
diag_log "________________	taskSetState	5_Big_Clear_Mount_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "5_Big_Clear_Mount Initializing";
};
...
[GF_Missions_allPlayers,["5_Big_Clear_Mount_1","GF_Missions_Pack"],["Clear Area","Clear Area",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["5_Big_Clear_Mount_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	5_Big_Clear_Mount.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "5_Big_Clear_Mount.sqf	Initialized";
};	
...
["5_Big_Clear_Mount_1","FAILED",true] spawn BIS_fnc_taskSetState;
["5_Big_Clear_Mount_2","FAILED",true] spawn BIS_fnc_taskSetState;
...
["5_Big_Clear_Mount_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;


//________________	Set Task 2	________________

[GF_Missions_allPlayers,["5_Big_Clear_Mount_2","GF_Missions_Pack"],["Defend the Area","Defend the Area",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["5_Big_Clear_Mount_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;	
...
["5_Big_Clear_Mount_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
