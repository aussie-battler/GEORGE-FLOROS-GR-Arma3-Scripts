...
diag_log "//________________	17_Big_Search_for_Supplies.sqf	Initializing	_____________";
diag_log "________________	taskSetState	17_Big_Search_for_Supplies_1	________________";
diag_log "________________	taskSetState	17_Big_Search_for_Supplies_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "17_Big_Search_for_Supplies Initializing";
};
...
_Target_1_array = selectRandom [
"Box_FIA_Wps_F",
"Box_FIA_Support_F",
"Box_FIA_Ammo_F"
]; 
_Target_1 = createVehicle [_Target_1_array, getpos _Building, [], 0, "CAN_COLLIDE"];
...
[GF_Missions_allPlayers,["17_Big_Search_for_Supplies_1","GF_Missions_Pack"],["Search for the Supplies","Search for the Supplies",""], _Pos_1,true,1,true,"search",true] call BIS_fnc_taskCreate;
["17_Big_Search_for_Supplies_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	17_Big_Search_for_Supplies.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "17_Big_Search_for_Supplies.sqf	Initialized";
};	
...
["17_Big_Search_for_Supplies_1","FAILED",true] spawn BIS_fnc_taskSetState;
["17_Big_Search_for_Supplies_2","FAILED",true] spawn BIS_fnc_taskSetState;
["17_Big_Search_for_Supplies_3","FAILED",true] spawn BIS_fnc_taskSetState;
sleep 5;
...
["17_Big_Search_for_Supplies_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["17_Big_Search_for_Supplies_2","GF_Missions_Pack"],["Destroy the Supplies","Destroy the Supplies",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["17_Big_Search_for_Supplies_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["17_Big_Search_for_Supplies_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["17_Big_Search_for_Supplies_3","GF_Missions_Pack"],["*** CAUTION Reinforcements ***","*** CAUTION Reinforcements ***",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["17_Big_Search_for_Supplies_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["17_Big_Search_for_Supplies_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
