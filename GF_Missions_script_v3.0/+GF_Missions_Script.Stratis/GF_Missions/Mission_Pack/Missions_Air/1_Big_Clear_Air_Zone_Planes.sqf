...
diag_log "//________________	1_Big_Clear_Air_Zone_Planes.sqf	Initializing	_____________";
diag_log "________________	taskSetState	1_Big_Clear_Air_Zone_Planes_1	________________";
diag_log "________________	taskSetState	1_Big_Clear_Air_Zone_Planes_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "1_Big_Clear_Air_Zone_Planes Initializing";
};
...
[GF_Missions_allPlayers,["1_Big_Clear_Air_Zone_Planes_1","GF_Missions_Pack"],["Clear Area","Clear Area",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["1_Big_Clear_Air_Zone_Planes_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	1_Big_Clear_Air_Zone_Planes.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "1_Big_Clear_Air_Zone_Planes.sqf	Initialized";
};	
...
["1_Big_Clear_Air_Zone_Planes_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["1_Big_Clear_Air_Zone_Planes_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
