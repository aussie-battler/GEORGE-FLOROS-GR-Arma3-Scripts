...
//________________  Author : GEORGE FLOROS [GR] ___________	29.01.19	_____________

/*
________________	GF Units Map Markers and Symbols Script - Mod	________________
...
if (GF_Units_Map_systemchat) then {
systemchat "GF Units Map Markers and Symbols Script Initializing";
};


if (GF_Units_Map_diag_log) then {
diag_log "//________________	GF_Units_Map_Markers_and_Symbols.sqf	_____________";
