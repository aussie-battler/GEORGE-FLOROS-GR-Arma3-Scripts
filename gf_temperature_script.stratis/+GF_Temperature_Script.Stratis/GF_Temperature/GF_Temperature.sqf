...
GF_Temperature_setDate				= true;

//	Select Type of Climate 	-->	  	1 = Hot Desert Climate , 2 = Mediterranean Climate , 3 = Subarctic Climate , 4 = custom
GF_Temperature_Climate_Type			= 3;	//	https://en.wikipedia.org/wiki/K%C3%B6ppen_Climate_classification	
...
Altidude Value : %11	\n
\n
Average Temperature Air Month : %12	\n 
Average Temperature Sea Month : %13	\n
\n
\n 
_____	Temperature	_____ 	\n
_____	Sum	_____ 	\n
\n 
Temperature Sum Air : %14	\n
Temperature Sum Sea : %15
" ,
GF_Temperature_Year,
