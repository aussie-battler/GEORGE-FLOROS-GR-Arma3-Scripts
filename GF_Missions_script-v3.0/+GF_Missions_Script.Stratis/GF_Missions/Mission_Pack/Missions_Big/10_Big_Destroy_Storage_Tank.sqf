...
diag_log "//________________	10_Big_Destroy_Storage_Tank.sqf	Initializing	_____________";
diag_log "________________	taskSetState	10_Big_Destroy_Storage_Tank_1	________________";
diag_log "________________	taskSetState	10_Big_Destroy_Storage_Tank_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "10_Big_Destroy_Storage_Tank Initializing";
};
...
_Target_1_Spawn = selectRandom _Target_1_array;
_Target_1 = _Target_1_Spawn createVehicle _Pos_1;
...
[GF_Missions_allPlayers,["10_Big_Destroy_Storage_Tank_1","GF_Missions_Pack"],["Destroy Storage Tank","Destroy Storage Tank",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["10_Big_Destroy_Storage_Tank_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	10_Big_Destroy_Storage_Tank.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "10_Big_Destroy_Storage_Tank.sqf	Initialized";
};	
...
["10_Big_Destroy_Storage_Tank_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["10_Big_Destroy_Storage_Tank_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
waitUntil { { _x distance _Target_1 > GF_Missions_Delete_Objects_Distance } count GF_Missions_allPlayers > 0 };
