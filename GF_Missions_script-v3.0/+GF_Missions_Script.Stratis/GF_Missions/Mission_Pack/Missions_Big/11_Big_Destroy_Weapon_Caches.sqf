...
diag_log "//________________	11_Big_Destroy_Weapon_Caches.sqf	Initializing	_____________";
diag_log "________________	taskSetState	11_Big_Destroy_Weapon_Caches_1	________________";
diag_log "________________	taskSetState	11_Big_Destroy_Weapon_Caches_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "11_Big_Destroy_Weapon_Caches Initializing";
};
...
[GF_Missions_allPlayers,["11_Big_Destroy_Weapon_Caches_1","GF_Missions_Pack"],["Destroy Weapon Caches","Destroy Weapon Caches",""], _Pos_1,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
["11_Big_Destroy_Weapon_Caches_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	11_Big_Destroy_Weapon_Caches.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "11_Big_Destroy_Weapon_Caches.sqf	Initialized";
};	
...
["11_Big_Destroy_Weapon_Caches_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["11_Big_Destroy_Weapon_Caches_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
