...
diag_log "//________________	8_Big_Clear_Area_Airport_Tanoa_Only.sqf	Initializing	_____________";
diag_log "________________	taskSetState	8_Big_Clear_Area_Airport_Tanoa_Only_1	________________";
diag_log "________________	taskSetState	8_Big_Clear_Area_Airport_Tanoa_Only_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "8_Big_Clear_Area_Airport_Tanoa_Only Initializing";
};
...
GF_Missions_pos = [] call GF_Missions_Pos_Airport_Tanoa_Only;
...
[GF_Missions_allPlayers,["8_Big_Clear_Area_Airport_Tanoa_Only_1","GF_Missions_Pack"],["Clear Area","Clear Area",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["8_Big_Clear_Area_Airport_Tanoa_Only_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	8_Big_Clear_Area_Airport_Tanoa_Only.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "8_Big_Clear_Area_Airport_Tanoa_Only.sqf	Initialized";
};	
...
["8_Big_Clear_Area_Airport_Tanoa_Only_1","FAILED",true] spawn BIS_fnc_taskSetState;
["8_Big_Clear_Area_Airport_Tanoa_Only_2","FAILED",true] spawn BIS_fnc_taskSetState;
...
["8_Big_Clear_Area_Airport_Tanoa_Only_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;


//________________	Set Task 2	________________

[GF_Missions_allPlayers,["8_Big_Clear_Area_Airport_Tanoa_Only_2","GF_Missions_Pack"],["Defend the Area","Defend the Area",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["8_Big_Clear_Area_Airport_Tanoa_Only_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;	
...
["8_Big_Clear_Area_Airport_Tanoa_Only_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
