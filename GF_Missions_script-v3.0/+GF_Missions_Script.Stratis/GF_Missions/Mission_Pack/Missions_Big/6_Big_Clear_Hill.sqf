...
diag_log "//________________	6_Big_Clear_Hill.sqf	Initializing	_____________";
diag_log "________________	taskSetState	6_Big_Clear_Hill_1	________________";
diag_log "________________	taskSetState	6_Big_Clear_Hill_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "6_Big_Clear_Hill Initializing";
};
...
GF_Missions_pos = [] call GF_Missions_Pos_Hill;
...
[GF_Missions_allPlayers,["6_Big_Clear_Hill_1","GF_Missions_Pack"],["Clear Area","Clear Area",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["6_Big_Clear_Hill_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	6_Big_Clear_Hill.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "6_Big_Clear_Hill.sqf	Initialized";
};	
...
["6_Big_Clear_Hill_1","FAILED",true] spawn BIS_fnc_taskSetState;
["6_Big_Clear_Hill_2","FAILED",true] spawn BIS_fnc_taskSetState;
...
["6_Big_Clear_Hill_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;


//________________	Set Task 2	________________

[GF_Missions_allPlayers,["6_Big_Clear_Hill_2","GF_Missions_Pack"],["Defend the Area","Defend the Area",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["6_Big_Clear_Hill_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;	
...
["6_Big_Clear_Hill_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
