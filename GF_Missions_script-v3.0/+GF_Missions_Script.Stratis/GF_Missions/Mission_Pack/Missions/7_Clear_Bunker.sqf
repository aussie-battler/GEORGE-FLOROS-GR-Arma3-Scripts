...
diag_log "//________________	7_Clear_Bunker.sqf	Initializing	_____________";
diag_log "________________	taskSetState	7_Clear_Bunker_1	________________";
diag_log "________________	taskSetState	7_Clear_Bunker_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "7_Clear_Bunker Initializing";
};
...
_Building = "Land_BagBunker_Large_F" createVehicle _Pos_1;
...
//________________	Garrison Buildings	________________ 

[_Building] spawn GF_Missions_Garrison_The_Building_Infantry;
[_Object_1] spawn GF_Missions_Garrison_The_Building_Infantry;
[_Object_2] spawn GF_Missions_Garrison_The_Building_Infantry;
...
[GF_Missions_allPlayers,["7_Clear_Bunker_1","GF_Missions_Pack"],["Clear the Bunker","Clear the Bunker",""], _Mission_Pos,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["7_Clear_Bunker_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	7_Clear_Bunker.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "7_Clear_Bunker.sqf	Initialized";
};	
...
["7_Clear_Bunker_1","FAILED",true] spawn BIS_fnc_taskSetState;
["7_Clear_Bunker_2","FAILED",true] spawn BIS_fnc_taskSetState;
...
["7_Clear_Bunker_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["7_Clear_Bunker_2","GF_Missions_Pack"],["*** CAUTION Reinforcements ***","*** CAUTION Reinforcements ***",""], _Pos_1,true,1,true,"defend",true] call BIS_fnc_taskCreate;
["7_Clear_Bunker_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["7_Clear_Bunker_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
