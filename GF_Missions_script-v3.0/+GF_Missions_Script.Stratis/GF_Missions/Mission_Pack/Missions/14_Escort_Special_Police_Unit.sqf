...
diag_log "//________________	14_Escort_Special_Police_Unit.sqf	Initializing	_____________";
diag_log "________________	taskSetState	14_Escort_Special_Police_Unit_1	________________";
diag_log "________________	taskSetState	14_Escort_Special_Police_Unit_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "14_Escort_Special_Police_Unit Initializing";
};
...
_Group_Police = [ _Pos_2, WEST, [
"B_officer_F","B_officer_F","B_officer_F","B_officer_F"
...
_Headgear_array = selectRandom [
			"H_PASGT_basic_black_F"
			]; 
			
_Goggles_array = selectRandom [
...
_x forceAddUniform _Uniform_array;
_x addHeadgear _Headgear_array;
_x addGoggles _Goggles_array;
...
for "_i" from 1 to 3 do {_x addItemToVest _magazineClass_weapon;};
for "_i" from 1 to 2 do {_x addItemToVest "FirstAidKit";};

for "_i" from 1 to 2 do {_x addItemToVest _items_loot3;};
for "_i" from 1 to 6 do {_x addItemToBackpack _magazineClass_weapon;};
...
[GF_Missions_allPlayers,["14_Escort_Special_Police_Unit_1","GF_Missions_Pack"],["Meet up with the Special Police Unit","Meet up with the Special Police Unit",""], _Offroad,true,1,true,"meet",true] call BIS_fnc_taskCreate;
["14_Escort_Special_Police_Unit_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	14_Escort_Special_Police_Unit.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "14_Escort_Special_Police_Unit.sqf	Initialized";
};	
...
["14_Escort_Special_Police_Unit_1","FAILED",true] spawn BIS_fnc_taskSetState;
["14_Escort_Special_Police_Unit_2","FAILED",true] spawn BIS_fnc_taskSetState;
["14_Escort_Special_Police_Unit_3","FAILED",true] spawn BIS_fnc_taskSetState;
sleep 5;
...
["14_Escort_Special_Police_Unit_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["14_Escort_Special_Police_Unit_2","GF_Missions_Pack"],["Move to Location , Follow directions","Move to Location",""], _Move,true,1,true,"move",true] call BIS_fnc_taskCreate;
["14_Escort_Special_Police_Unit_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["14_Escort_Special_Police_Unit_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
...
[GF_Missions_allPlayers,["14_Escort_Special_Police_Unit_3","GF_Missions_Pack"],["Clear Residential Area","Clear Residential Area",""], _Pos_1,true,1,true,"move",true] call BIS_fnc_taskCreate;
["14_Escort_Special_Police_Unit_3","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["14_Escort_Special_Police_Unit_3", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;
sleep 5;
