...
diag_log "//________________	5_Search_Stolen.sqf	Initializing	_____________";
diag_log "________________	taskSetState	5_Search_Stolen_1	________________";
diag_log "________________	taskSetState	5_Search_Stolen_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "5_Search_Stolen Initializing";
};
...
_Building = createVehicle ["Land_TentHangar_V1_F", _Pos_1, [], 0, "CAN_COLLIDE"];
...
[GF_Missions_allPlayers,["5_Search_Stolen_1","GF_Missions_Pack"],["Search for the Stolen Vehicle","Search for the  Stolen Vehicle",""], _Mission_Pos,true,1,true,"kill",true] call BIS_fnc_taskCreate;
["5_Search_Stolen_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	5_Search_Stolen.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "5_Search_Stolen.sqf	Initialized";
};	
...
["5_Search_Stolen_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
["5_Search_Stolen_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
