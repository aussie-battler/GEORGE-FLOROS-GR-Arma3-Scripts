...
diag_log "//________________	15_Find_the_Prisoners.sqf	Initializing	_____________";
diag_log "________________	taskSetState	15_Find_the_Prisoners_1	________________";
diag_log "________________	taskSetState	15_Find_the_Prisoners_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "15_Find_the_Prisoners Initializing";
};
...
_Object_1_Pos = [_Pos_1, 12, 0] call BIS_fnc_relPos;
_Object_2_Pos = [_Pos_1, 24, 0] call BIS_fnc_relPos;
_Object_3_Pos = [_Pos_1, 36, 0] call BIS_fnc_relPos;
...
_Object_3 = "C_Offroad_01_white_F" createVehicle _Object_3_Pos;
_Object_3 setDamage 0.9;



[] spawn GF_Missions_Spawn_Infantry_Prisoners_Armed_Patrol;
[] spawn GF_Missions_Spawn_Infantry_Prisoners_Armed_Patrol;
[] spawn GF_Missions_Spawn_Infantry_Prisoners_Armed_Defend;
[] spawn GF_Missions_Spawn_Infantry_Prisoners_Armed_Attack;
...
[GF_Missions_allPlayers,["15_Find_the_Prisoners_1","GF_Missions_Pack"],["Prisoners have Escaped , Find the Prisoners",""], _Pos_1,true,1,true,"scout",true] call BIS_fnc_taskCreate;
["15_Find_the_Prisoners_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	15_Find_the_Prisoners.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "15_Find_the_Prisoners.sqf	Initialized";
};	
...
["15_Find_the_Prisoners_1","FAILED",true] spawn BIS_fnc_taskSetState;
["15_Find_the_Prisoners_2", "FAILED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
waitUntil { { _x distance _Pos_1 < 400 } count GF_Missions_allPlayers > 0 };
...
["15_Find_the_Prisoners_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
...
[GF_Missions_allPlayers,["15_Find_the_Prisoners_2","GF_Missions_Pack"],["The Prisoners are 400 meters away , they are armed , Eliminate all Threats","Eliminate all Threats",""], _Pos_1,true,1,true,"attack",true] call BIS_fnc_taskCreate;
["15_Find_the_Prisoners_2","ASSIGNED",true] spawn BIS_fnc_taskSetState;
...
["15_Find_the_Prisoners_2", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
