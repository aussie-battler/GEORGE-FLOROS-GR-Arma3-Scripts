...
diag_log "//________________	3_Eliminate_Suspects.sqf	Initializing	_____________";
diag_log "________________	taskSetState	3_Eliminate_Suspects_1	________________";
diag_log "________________	taskSetState	3_Eliminate_Suspects_2	________________";


if (GF_Missions_Systemchat_info) then {
systemchat "3_Eliminate_Suspects Initializing";
};
...
//________________	_Group_2	________________

_Pos_Spawn =  [[[_Pos_1, 25 + random 100]],["water"]] call BIS_fnc_randomPos;
_Group_2 = createGroup GF_Missions_Enemy_Side;

for "_x" from 0 to (GF_Missions_Squad_Members) do {

_Unit = _Group_2 createunit [GF_Missions_Pool_Civilian select floor(random count GF_Missions_Pool_Civilian),_Pos_Spawn,[],0,"None"];
[_Unit] JoinSilent _Group_2;
...
[_Group_2,_Pos_1,GF_Missions_BIS_fnc_taskPatrol_distance] call BIS_fnc_taskPatrol;
...
[GF_Missions_allPlayers,["3_Eliminate_Suspects_1","GF_Missions_Pack"],["Eliminate the Suspects","Eliminate the Suspects",""], _Mission_Pos,true,1,true,"kill",true] call BIS_fnc_taskCreate;
["3_Eliminate_Suspects_1","ASSIGNED",true] spawn BIS_fnc_taskSetState;


diag_log "//________________	3_Eliminate_Suspects.sqf	Initialized	_____________";

if (GF_Missions_Systemchat_info) then {
systemchat "3_Eliminate_Suspects.sqf	Initialized";
};	
...
["3_Eliminate_Suspects_1","FAILED",true] spawn BIS_fnc_taskSetState;
...
//________________	Check Task	________________
	...
	waitUntil {({alive _x} count units _Group_2) isEqualTo 0;};
...
["3_Eliminate_Suspects_1", "SUCCEEDED",true] spawn BIS_fnc_taskSetState;			
sleep 5;
