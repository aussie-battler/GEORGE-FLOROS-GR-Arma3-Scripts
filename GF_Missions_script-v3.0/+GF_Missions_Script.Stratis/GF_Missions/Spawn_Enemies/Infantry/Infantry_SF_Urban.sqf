...
[] spawn GF_Missions_Garrison_The_Building_Infantry_SF_Urban;			//	add the name of the building ex : [_Building] spawn GF_Missions_Garrison_The_Building_Infantry;
[] spawn GF_Missions_Garrison_Area_Buildings_Infantry_SF_Urban;
*/


//________________	GF_Missions_Spawn_Infantry_SF_Urban_Patrol	________________

GF_Missions_Spawn_Infantry_SF_Urban_Patrol = {
...
_unit = _Group createunit [GF_Missions_Pool_Infantry_SF_Urban select floor(random count GF_Missions_Pool_Infantry_SF_Urban),_Pos_Spawn,[],0,"None"];
...
//________________	GF_Missions_Spawn_Infantry_SF_Urban_Defend	________________	

GF_Missions_Spawn_Infantry_SF_Urban_Defend = {
...
//________________	GF_Missions_Spawn_Infantry_SF_Urban_Attack	________________

GF_Missions_Spawn_Infantry_SF_Urban_Attack = {
...
//________________	GF_Missions_Garrison_The_Building_Infantry_SF_Urban	________________ 

GF_Missions_Garrison_The_Building_Infantry_SF_Urban = {
...
//________________	GF_Missions_Garrison_Area_Buildings_Infantry_SF_Urban	________________ 

GF_Missions_Garrison_Area_Buildings_Infantry_SF_Urban = {
...
for "_i" from 0 to 50 do {
	...
	_Group = createGroup GF_Missions_Enemy_Side;
	_Unit = _Group createunit [GF_Missions_Pool_Infantry_SF_Urban select floor(random count GF_Missions_Pool_Infantry_SF_Urban),_buildingpos,[],0,"None"];
	[_Unit] JoinSilent _Group;
	_Unit disableAI "PATH";
