...
//________________	GF_Missions_Spawn_Helicopters_Transport_Patrol	________________

GF_Missions_Spawn_Helicopters_Transport_Patrol = {
...
_Helicopter = selectRandom GF_Missions_Pool_Helicopters_Transport; 
...
//________________	GF_Missions_Spawn_Helicopters_Transport_Defend	________________

GF_Missions_Spawn_Helicopters_Transport_Defend = {
...
//________________	GF_Missions_Spawn_Helicopters_Transport_Attack	________________

GF_Missions_Spawn_Helicopters_Transport_Attack = {
...
_Altidude = round((getPosASL _Spawned_Helicopter) select 2);
_Spawned_Helicopter flyInHeight _Altidude;

//________________	 addwaypoint	________________

_random_Wp = _Pos getPos [3000,random 360];
_Wp_2 = _Group_Crew addwaypoint [(_random_Wp),0];
...
waitUntil { _Spawned_Helicopter distance2D _Pos > 2500 };
