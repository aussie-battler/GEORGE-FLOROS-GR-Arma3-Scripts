...
//	this setVariable ["Var_GF_SCL_allUnits", true];
	
	
diag_log "//________________	GF Set Custom Loadout Script Initializing	_____________";
diag_log "//________________	GF_SCL_allUnits.sqf	_____________";

systemchat "GF Set Custom Loadout Script Initializing";


//________________ GF_SCL_allUnits.sqf _____________


GF_SCL_allUnits_primaryWeapon_array = [
//	LightMachineGuns
...
GF_SCL_allUnits_secondaryWeapon_array = [
	// Launchers
...
GF_SCL_allUnits_handgunWeapon_array = [
//	Pistols
"hgun_ACPC2_F",
"hgun_P07_F",
...
GF_SCL_allUnits_Civilian_Uniform_Custom_array = [
...
GF_SCL_allUnits_Backpacks_array = [
"B_AssaultPack_blk",
"B_AssaultPack_cbr",
"B_AssaultPack_dgtl",
"B_AssaultPack_khk",
...
GF_SCL_allUnits_Headgear_array = [
"H_Cap_blk",
"H_Cap_blk_Raven",
"H_Cap_blu",
"H_Cap_brn_SPECOPS",
...
GF_SCL_allUnits_Ravage_items_array = [		
//	Ravage_items
//	x1
...
GF_SCL_allUnits_ACE3_mod_Medical_array = [
"ACE_atropine",
"ACE_fieldDressing",
"ACE_elasticBandage",
"ACE_quikclot",
...
GF_SCL_allUnits_ACE3_mod_items_array = [
//	AtragMX
"ACE_ATragMX",
...
GF_SCL_allUnits_Exclude_List_Gear = [
...
_this addEventHandler ["Respawn", {
	...
	_unit setVariable ["Var_GF_SCL_allUnits",false];
}];
};

//________________	Randomize	________________

_Uniform = selectRandom GF_SCL_allUnits_Uniform_array;	//	For Civilian : GF_SCL_allUnits_Civilian_Uniform_Custom_array
_Headgear = selectRandom GF_SCL_allUnits_Headgear_array; 
_Goggles = selectRandom GF_SCL_allUnits_Goggles_array; 
_Vests = selectRandom GF_SCL_allUnits_Vests_array; 
_Backpacks = selectRandom GF_SCL_allUnits_Backpacks_array;
_primaryWeapon = selectRandom GF_SCL_allUnits_primaryWeapon_array;
_secondaryWeapon = selectRandom GF_SCL_allUnits_secondaryWeapon_array;
_handgunWeapon = selectRandom GF_SCL_allUnits_handgunWeapon_array;


//________________ addItemToVest	________________

_items_array_1_addtoVest = selectRandom GF_SCL_allUnits_items_array_1;
_items_array_2_addtoVest = selectRandom GF_SCL_allUnits_items_array_2;
_items_array_3_addtoVest = selectRandom GF_SCL_allUnits_items_array_3;
_Ravage_items_array_addtoVest = selectRandom GF_SCL_allUnits_Ravage_items_array;
_ACE3_mod_Medical_array_addtoVest = selectRandom GF_SCL_allUnits_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoVest = selectRandom GF_SCL_allUnits_ACE3_mod_items_array;

//________________ addItemToBackpack	________________

_items_array_1_addtoBackpack = selectRandom GF_SCL_allUnits_items_array_1;
_items_array_2_addtoBackpack = selectRandom GF_SCL_allUnits_items_array_2;
_items_array_3_addtoBackpack = selectRandom GF_SCL_allUnits_items_array_3;
_Ravage_items_array_addtoBackpack = selectRandom GF_SCL_allUnits_Ravage_items_array;
_ACE3_mod_Medical_array_addtoBackpack = selectRandom GF_SCL_allUnits_ACE3_mod_Medical_array;
_ACE3_mod_items_array_addtoBackpack = selectRandom GF_SCL_allUnits_ACE3_mod_items_array;
...
if (_removeallweapons) then {
	...
	if (!((typeOf _this) in GF_SCL_allUnits_Exclude_List_Gear)) then {
	removeallweapons _this;
	};
...
GF_SCL_allUnits_Change_Equipment_civilian = {
...
_Uniform = selectRandom GF_SCL_allUnits_Civilian_Uniform_Custom_array;	//	GF_SCL_allUnits_Uniform_array;
_Headgear = selectRandom GF_SCL_allUnits_Headgear_array; 
_Goggles = selectRandom GF_SCL_allUnits_Goggles_array; 
_Vests = selectRandom GF_SCL_allUnits_Vests_array; 
_Backpacks = selectRandom GF_SCL_allUnits_Backpacks_array;
...
3.	you can also spawn this for a certain unit :
	name this unit  ex : GF_SCL_allUnits_1
	GF_SCL_allUnits_1 spawn GF_SCL_allUnits;
 
4. 	you can also spawn this for a certain unit in the Editor :
	add this in the init of a unit :
	null = this execVM "GF_SCL_allUnits\GF_SCL_allUnits.sqf";

	and add instead of the spawn code in the end :
	_this spawn GF_SCL_allUnits;
	
5.	only for player : 
	player spawn GF_SCL_allUnits;
	
6.	for everyone : 
	null = {_x spawn GF_SCL_allUnits_Spawn_Custom_Equipment;}forEach allUnits;
*/
//________________	End	________________	 
...
[] spawn {
	while {true} do {		
		...
		&& (!((typeOf _x) in GF_SCL_allUnits_Exclude_List)) 
