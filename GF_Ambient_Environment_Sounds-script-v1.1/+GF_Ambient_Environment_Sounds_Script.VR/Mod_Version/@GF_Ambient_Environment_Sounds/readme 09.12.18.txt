...
GF Ambient Environment Sounds Script , create your desired , Ambient Environment.
...
For usage instructions and information of how to use the GF Ambient Environment Sounds Script please refer to the included documentation and/or example mission.
Place in your mission the files . There is everything included , in the initServer.sqf and the Description.ext , to copy paste in your mission .
...
You can add your custom sounds.
It is also included a mod version , posible to unpack and edit. 
The sound files including  , day and night ambience according to time.
The script will prevent running , when the player is inside a vehicle or water.
There are sound files for birds , insects and some forest SFX , also 
a day and a night ambient loop.
...
Forum topic:
- BI forums https://forums.bohemia.net/forums/topic/219857-gf-ambient-environment-sounds-script/
- Armaholic forums http://www.armaholic.com/forums.php?m=posts&q=40255
