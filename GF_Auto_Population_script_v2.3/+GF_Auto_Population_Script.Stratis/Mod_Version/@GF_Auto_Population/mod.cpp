...
name = "GF Auto Population Script - Mod";
overview = "GF Auto Population Script - Mod<br />Description:<br />will work automatically and populate every Map and Water Maps as well , with enemies on infinite. It is posible to unpack and edit<br />by GEORGE FLOROS [GR], enjoy!";
actionName = "BIS Forums";
action = "https://forums.bohemia.net/profile/1141978-george-floros-gr/";
picture = "GF_LOGO.paa";
logo = "GF_LOGO.paa";
logoOver = "GF_LOGO.paa";
logoSmall = "GF_LOGO.paa";