...
GF Use Every Uniform , a simple example on how to.
...
For usage instructions and information of how to use the GF Use Every Uniform,  please refer to the included documentation and/or example mission.
Place in your mission the files . There is everything included , in the example mission , to copy paste in your mission .
...
It is just a simple example ,how to be able,
to use every Uniform , from every side.
You have to put a Civilian in the editor 
and then link him with another AI , 
from the desired side.
You can copy the example (ctrl+c) and paste (ctrl+v) to your mission.
It's working with every addon.
...
Forum topic:
- BI forums https://forums.bohemia.net/forums/topic/217421-gf-use-every-uniform/
- Armaholic http://www.armaholic.com/forums.php?m=posts&q=40096
