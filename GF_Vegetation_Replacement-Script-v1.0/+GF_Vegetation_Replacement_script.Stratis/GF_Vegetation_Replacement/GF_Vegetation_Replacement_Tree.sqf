...
Waituntil{sleep 1;GF_Vegetation_Replacement_Preset_Trees_initialized};
...
diag_log "//________________	GF_Vegetation_Replacement_Tree.sqf	________________";
...
_createVehicle = createVehicle [selectrandom GF_Vegetation_Replacement_Tree_array, _pos, [], 0, "CAN_COLLIDE"];
...
//	systemchat format["Replaced Trees : %1 ",GF_Vegetation_Replacement_Tree_Count];
};
