...
Waituntil{sleep 1;GF_VR_Preset_Bush_initialized};
...
diag_log "//________________	GF_VR_Bush.sqf	________________";
...
{
GF_VR_Bush_Count = GF_VR_Bush_Count + 1;

GF_VR_Bush_Objects = _x;
...
_createVehicle = createVehicle [selectrandom GF_VR_Bush_array, _pos, [], 0, "CAN_COLLIDE"];
...
//	systemchat format["Replaced Bushs : %1 ",GF_VR_Bush_Count];
};

};

}forEach GF_VR_Bush_Objects;
